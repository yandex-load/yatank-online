...
(function() {
  var app, collect_monitoring, collect_stats, collect_subtree,
  ...
  collect_stats = function(stats) {
    var i, len, metric, ref, result, statItem, value;
    result = {};
  ...
  collect_monitoring = function(monitoring) {
    var host, hostData, i, len, metric, monItem, ref, ref1, result, subgroup, value;
    result = {};
    for (i = 0, len = monitoring.length; i < len; i++) {
      monItem = monitoring[i];
      monItem = monItem[0];
      ref = monItem.data;
      for (host in ref) {
        hostData = ref[host];
  ...
  app.controller("TankReport", function($scope, $element) {
    ...
    $scope.buildSeries = function() {
      var areaGraphs, cache, data, hostData, hostname, metric, metrics, monitoringData, name, overallData, series, statsData, subgroup, taggedData;
